...
export default function NewEmployee() {
  ...
  const handleEmployeeSelect = (employee: SavedEmployee) => {
    ...
    const selectedCountry = countries.find((c) => c.name === employee.country);
    if (selectedCountry) {
      setSelectedPhoneCode({
  ...
  const filteredEmployees = SAVED_EMPLOYEES.filter(
    (emp) =>
      emp.firstName +
      " " +
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-gray-600 bg-[#F5F6F7] rounded-[8px] focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                  placeholder=""
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-3 text-gray-600 bg-[#F5F6F7] rounded-[8px] focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                    placeholder=""
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative" ref={countryDropdownRef}>
                  ...
                  >
                    <span
                      className={
                        formData.country ? "text-gray-900" : "text-gray-600"
                      }
                    >
                      {formData.country || "--"}
                    </span>
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 text-gray-500 bg-[#F5F6F7] rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all pr-10"
                />
