...
<p align="center">
  <a href="https://github.com/euniceotowo/fluxinvoice/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-green.svg" alt="License"></a>
...
**Fluxinvoice** is a professional payroll and invoicing system built on the Stellar network. It enables businesses, contractors, and individuals to manage global payments with automated tax handling using both fiat and stablecoins.
...
1. **Clone and Prepare**:
   ...
   ```bash
   git clone https://github.com/euniceotowo/fluxinvoice.git
   cd fluxinvoice
   cp .env.example .env
   ```
...
[![Contributors](https://contrib.rocks/image?repo=euniceotowo/fluxinvoice)](https://github.com/euniceotowo/fluxinvoice/graphs/contributors)
